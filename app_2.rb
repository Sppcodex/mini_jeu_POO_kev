...
|-------------------------------------------------|"                                       # --> Message de présentation du jeu
  ...
  Jaco = Player.new("Jaco")                                                          # --> Création des "bots" ou ennemies
  ennemies = [Kevin, Jaco]                                                               # --> stocker dans un array pour pouvoir les appeler dans des boucle
  ...
  while player1.life_points >0 && (Kevin.life_points > 0 || Jaco.life_points >0)         # --> début du jeu     
